    <div class="main-contant">
    	<div class="container">
            <?php $item = $detalle_articulo_talento->row(); ?>
        	 <h2 class="h-style"><?php echo $item->titulo_talento; ?></h2>
            <div class="row">
                <div class="span8">
                            ...
                            <section class="fashion-slider">
                                <div class=" slider flexslider">
                                  ...
                                  <?php if (!empty($item-> foto1)){  $foto_redes = $item-> foto1; ?>
                                    <li><figure> <img src="<?php echo base_url();?>fotos_talento_humano/<?php echo $item-> foto1; ?>"  alt="<?php echo $item -> foto1;?>"></figure></li>
                                  <?php } ?>
                                  <?php if (!empty($item-> foto2)){ ?>
                                    <li><figure> <img src="<?php echo base_url();?>fotos_talento_humano/<?php echo $item-> foto2; ?>"  alt="<?php echo $item -> foto2;?>"></figure></li>
                                  <?php } ?>
                                  <?php if (!empty($item-> foto3)){ ?>
                                    <li><figure> <img src="<?php echo base_url();?>fotos_talento_humano/<?php echo $item-> foto3; ?>"  alt="<?php echo $item -> foto3;?>"></figure></li>
                                  <?php } ?>
                                  <?php if (!empty($item-> foto4)){ ?>
                                    <li><figure> <img src="<?php echo base_url();?>fotos_talento_humano/<?php echo $item-> foto4; ?>"  alt="<?php echo $item -> foto4;?>"></figure></li>
                                  <?php } ?>
                                  <?php if (!empty($item-> foto5)){ ?>
                                    <li><figure> <img src="<?php echo base_url();?>fotos_talento_humano/<?php echo $item-> foto5; ?>"  alt="<?php echo $item -> foto5;?>"></figure></li>
                                  <?php } ?>
                                  <?php if (!empty($item-> foto6)){ ?>
                                    <li><figure> <img src="<?php echo base_url();?>fotos_talento_humano/<?php echo $item-> foto6; ?>"  alt="<?php echo $item -> foto6;?>"></figure></li>
                                  <?php } ?>
                                  </ul>
                                </div>
                             </section>
                             <?php if (!empty($item->contenido_talento)){ ?>
                                <div class="text">
                                        <?php echo $item->contenido_talento; ?>
                                </div>
                            <?php } ?>
                            <?php if (!empty($item->ficha_talento)){ ?>
                                <div><hr></div>
                                <div>
                                    <p class="pull-right" style="margin-right: 20px;"><img src="https://cdn.worldvectorlogo.com/logos/adobe-pdf-icon.svg" width="25"> <a href="<?php echo base_url();?>fotos_talento_humano/<?php echo $item->ficha_talento; ?>">DESCARGA LA FICHA TÉCNICA </a></p> <br>
                                </div>
                            <?php } ?>
                            <div><hr></div>
                                       <!-- REDES SOCIALES -->
                                        <div>
                                            <ul class="social-icons2">
                                               <?php $enlace = base_url()."talento_humano/detalle_articulo_talento/".$item-> url_amigable_talento; ?>
