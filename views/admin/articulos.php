      ...
      <section id="content" class="animated fadeIn">
            ...
            <div class="panel mb25 mt5">
              <div class="panel-heading">
                <span class="panel-title hidden-xs"> <i class="fa fa-cubes text-danger"></i> Agregar un nuevo articulo</span>
              ...
              <form action="<?php echo base_url();?>admin/articulos/insertar_articulo" enctype="multipart/form-data"  method="post" accept-charset="utf-8">    <!-- FORMULARIO INSERTAR -->
                    ...
                    <div class="section row mbn">
                      <div class="col-md-12 pl15">
                        <div class="col-md-3 mb10">
                          <label for="nombre_articulo" class="field prepend-icon">
                          <input type="text" name="nombre_articulo" id="nombre_articulo" class="event-name gui-input br-light light" placeholder="Autor / Fuente">
                          <label for="nombre_articulo" class="field-icon">
                            <i class="fa fa-cubes"></i>
                          </label>
                          </label>
                        </div>
                        <div class="col-md-3 mb10">
                          <label for="titulo_articulo" class="field prepend-icon">
                          <input type="text" name="titulo_articulo" id="titulo_articulo" class="event-name gui-input br-light light" placeholder="Titulo Artículo" required>
                          <label for="titulo_articulo" class="field-icon">
                            <i class="fa fa-ticket"></i>
                          </label>
                          </label>
                        </div>
                        <div class="col-md-3 mb10">
                          <label for="id_seccion" class="field select">
                            <select id="id_seccion" name="seccion_articulo" required>
                        ...
                        <div class="col-md-3 mb10">
                          <label for="keywords_articulo" class="field prepend-icon">
                          <input type="text" name="keywords_articulo" id="keywords_articulo" class="event-name gui-input br-light light" placeholder="Palabras clave" required>
                          <label for="keywords_articulo" class="field-icon">
                            <i class="fa fa-tags"></i>
                          </label>
                          </label>
                        </div>
                        <div class="col-md-3 mb10">
                          <label for="video_articulo" class="field prepend-icon">
                          <input type="text" name="video_articulo" id="video_articulo" class="event-name gui-input br-light light" placeholder="video articulo">
                          <label for="video_articulo" class="field-icon">
                            <i class="fa fa-youtube-play"></i>
                          </label>
                          </label>
                        </div>
                        <div class="col-md-3 mb10">
                          <label for="estado_articulo" class="field select">
                        ...
                        <div class="col-md-3 mb10">
                          ...
                          <input type="text" name="url_amigable_articulo" id="url_amigable_articulo" class="event-name gui-input br-light light" placeholder="url amigable" required>
                        ...
                        <div class="col-md-3 mb10">
                          <label for="fecha_publicacion_articulo" class="field prepend-icon">
                          <input type="date" name="fecha_publicacion_articulo" id="fecha_publicacion_articulo" class="event-name gui-input br-light light" required>
                          <label for="fecha_publicacion_articulo" class="field-icon">
                        ...
                        <div class="col-md-12 mb10"> 
                              <textarea name="descripcion_articulo" class="form-control">Descripción para listados</textarea>
                        </div>                  
                    </div> 
                  </div>
                </div><!-- end tab-->
            ...
            <div class="col-md-12 pl15">
                ...
                <div class="col-md-6 text-left">
                  ...
                  Destacado en Listado
                    <input name="destacado_articulo" id="exampleCheckboxSwitch6" type="checkbox" value="si" >
                    <label for="exampleCheckboxSwitch6"></label>
                  </div>
                </div>
                  <div class="col-md-6 text-right">
                     <input type="submit" name="crear_articulo" class="btn btn-danger" value="Crear articulo">
                  </div>
            </div>
          </form>
              ...
              <div class="panel panel-visible" id="spy2">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Listado de articulos</div>
                </div>
                  ...
                  <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td><img src="<?php echo base_url()."fotos_articulos/".$articulo -> foto0 ?>" width=50 ></td>
                          <td><?php echo $articulo -> titulo_articulo ?></td>
                          <td><?php echo $articulo -> nombre_articulo?></td>
                          <td><?php echo $articulo -> estado_articulo ?></td>
                          <td><?php echo $articulo -> destacado_articulo ?></td>
                          <td>  
                            <a href="<?php echo base_url();?>admin/articulos/articulo_edit/<?php echo $articulo -> id_articulo ?>" type="button" class="btn btn-warning" > 
                            <span class="fa fa-pencil"></span> </a>
                            <a href="<?php echo base_url();?>admin/articulos/borrar_articulo/<?php echo $articulo -> id_articulo ?>" type="button" class="btn btn-danger confirmation" > 
  ...
  jQuery(document).ready(function() {
    ...
    $(".confirmation").click(function(){
      return confirm('¿Está seguro de borrar este articulo?');
    });
