    ...
    <section id="content_wrapper">
      ...
      <section id="content" class="animated fadeIn">
            ...
            <div class="panel mb25 mt5">
              ...
              <form action="<?php echo base_url();?>admin/seguros/insertar_seguro" enctype="multipart/form-data"  method="post" accept-charset="utf-8">    <!-- FORMULARIO INSERTAR -->
                    ...
                    <div class="section row mbn">
                      <div class="col-md-12 pl15">
                        ...
                        <div class="col-md-3 mb10">
                          ...
                          <label for="titulo_seguro" class="field-icon">
                        ...
                        <div class="col-md-3 mb10">
                          ...
                          <label for="subtitulo_seguro" class="field-icon">
                        ...
                        <div class="col-md-3 mb10">
                          ...
                          <label for="keywords_seguro" class="field-icon">
                            <i class="fa fa-tags"></i>
                          </label>
                          </label>
                        </div>
                        <div class="col-md-3 mb10">
                          <label for="video_seguro" class="field prepend-icon">
                          <input type="text" name="video_seguro" id="video_seguro" class="event-name gui-input br-light light" placeholder="video">
                          <label for="video_seguro" class="field-icon">
                            <i class="fa fa-youtube-play"></i>
                          </label>
                          </label>
                        </div>
                        <div class="col-md-3 mb10">
                          <label for="estado_seguro" class="field select">
                          <select id="estado_seguro" name="estado_seguro" required="">
                        ...
                        <div class="col-md-3 mb10">
                          ...
                          <input type="text" name="url_amigable_seguro" id="url_amigable_seguro" class="event-name gui-input br-light light" placeholder="url amigable" required>
                        ...
                        <div class="col-md-3 mb10">
                          <label for="fecha_publicacion_seguro" class="field prepend-icon">
                          <input type="date" name="fecha_publicacion_seguro" id="fecha_publicacion_seguro" class="event-name gui-input br-light light" required>
                          <label for="fecha_publicacion_seguro" class="field-icon">
                        ...
                        <div class="col-md-12 mb10"> 
                              <textarea name="descripcion_seguro" class="form-control">Descripción</textarea>
                        </div>                  
                    </div> 
                  </div>
                </div><!-- end tab-->
            ...
            <div class="col-md-12 pl15">
                ...
                <div class="col-md-6 text-left">
                  ...
                  Destacado en Listado
                    <input name="destacado_seguro" id="exampleCheckboxSwitch6" type="checkbox" value="si" >
                    <label for="exampleCheckboxSwitch6"></label>
                  </div>
                </div>
                  <div class="col-md-6 text-right">
                     <input type="submit" name="crear_seguro" class="btn btn-danger" value="Crear seguro">
                  </div>
            </div>
          </form>
              ...
              <div class="panel panel-visible" id="spy2">
                <div class="panel-heading">
                  <div class="panel-title hidden-xs">
                    <span class="glyphicon glyphicon-tasks"></span>Listado de seguros</div>
                </div>
