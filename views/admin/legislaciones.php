                      ...
                      <div class="col-md-12 pl15">
                       ...
                       <div class="col-md-3 mb10">
                        ...
                        <div class="col-md-3 mb10">
                          ...
                          <input type="text" name="url_amigable_legislacion" id="url_amigable_legislacion" class="event-name gui-input br-light light" placeholder="url amigable" required>
                  ...
                  <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td> <a href="<?php echo base_url();?>legislaciones/<?php echo $legislacion-> ficha_legislacion; ?>"><?php echo $legislacion-> ficha_legislacion; ?></a></td>
                          <td>  
