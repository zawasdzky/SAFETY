            ...
            <!-- DATA TABLE -->
              <div class="panel panel-visible" id="spy2">
                ...
                <div class="panel-body pn">
                  <button id="exportar_excel" class="btn btn-success"> Exportar Excel</button>
                  <div id="contenedor_export_excel"> 
                      <table class="table table-striped table-hover" id="datatable2" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                              <td align="center"><?php echo $newsletter -> id_newsletter ?></td>
  ...
  jQuery(document).ready(function() {
    ...
    $('.dataTables_filter input').attr("placeholder", "Buscar");
      ...
      //Exportar a Excel
    $("[id$=exportar_excel]").click(function(e) {
        window.open('data:application/vnd.ms-excel,' + encodeURIComponent( $('div[id$=contenedor_export_excel]').html()));
        e.preventDefault();
    });
